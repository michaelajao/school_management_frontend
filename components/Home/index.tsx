          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md border border-slate-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                ...
                <Button className="w-full bg-[#1B5B5E] hover:bg-[#1B5B5E]/90 transition-all duration-300 hover:shadow-lg hover:scale-105" asChild onClick={() => setSelectedPlan("freemium")}>
                  <Link href="/auth/signup">Get Started</Link>
                </Button>
              </div>
