 ...
 */
const CustomTooltip = ({ active, payload }: { active: boolean, payload: { value: number }[] | null }): JSX.Element | null => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex gap-4 flex-wrap">
        <Button variant="outline" className="text-[#FF9F43]">Add New User</Button>

        {/* new button component added here */}
        <CustomButton
          variant="outline"
          size="sm"
          className="w-[160px] h-[48px] rounded-[10px] border-[0.5px] border-[#008080] text-[#008080] hover:bg-[#008080] hover:text-[#fff]"
        >
        ...
        <CustomButton
          variant="outline"
          size="sm"
          className="w-[184px] h-[48px] rounded-[10px] border-[0.5px] border-[#8B5CF6] text-[#8B5CF6] hover:bg-[#8B5CF6] hover:text-[#fff]"
        >
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              ...
              >
                ...
                <Bar dataKey="expenses" name="Expenses" fill="#60a5fa" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <p className="text-sm">
                Amount Collected: <span className="font-bold">₦12,500,000</span>
              </p>
        ...
        <Card className="border border-gray-200 shadow-sm rounded-md">
          <CardHeader className="flex flex-row justify-between items-center pb-4 pt-4 px-6">
            ...
            <CustomButton
              ...
              size="md"
              icon={<Plus />}
              className="px-2 rounded-[10px] border-[0.5px] border-[#008080] text-[#008080] hover:bg-[#008080] hover:text-[#fff]"
            >
              Create Event
            </CustomButton>
          </CardHeader>
        ...
        <Card className="border border-gray-200 shadow-sm rounded-md">
          <CardHeader className="flex flex-row justify-between items-center pb-4 pt-4 px-6">
            ...
            <CustomButton
              ...
              size="sm"
              icon={<Plus />}
              className="h-[36px] rounded-[10px] border-[0.5px] border-[#008080] text-[#008080] hover:bg-[#008080] hover:text-[#fff]"
            >
              Create Announcement
            </CustomButton>
          </CardHeader>
              ...
              {announcements.map(announcement => (
                <li key={announcement.id} className="relative">
                  <div className="flex items-start gap-3">
                    <div className="mt-1 w-4 h-4 rounded-full bg-teal-500 flex-shrink-0"></div>
                    <div>
                      <p className="text-gray-800 font-medium mb-1">{announcement.content}</p>
                      {announcement.highlight && (
                        <div className="absolute right-0 top-1/2 transform -translate-y-1/2">
                          <span className="bg-blue-500 text-white px-1 py-0.5 text-xs rounded-l">{announcement.highlight.prefix}</span>
                          <span className="bg-blue-300 text-white px-1 py-0.5 text-xs rounded-r">{announcement.highlight.text}</span>
                        </div>
                      )}
                      <p className="text-teal-500 text-xs">{announcement.date}</p>
                    </div>
                  </div>
                </li>
              ))}
