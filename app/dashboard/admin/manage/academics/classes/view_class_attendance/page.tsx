...
import { Download, ChevronDown, ChevronUp, Search, Users, FileText, GraduationCap, SlidersHorizontal, MoreHorizontal } from "lucide-react";
          ...
          <TableBody>
            {attendanceData.map((item, index) => (
              <TableRow key={index}>
                ...
                <TableCell>
                  <button onClick={() => {router.push('/(users)/admin/academics/classes/view_class_attendance/individual_attendance')}} className="hover:text-gray-700" title="View individual attendance">
