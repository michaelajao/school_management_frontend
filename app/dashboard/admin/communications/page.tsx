...
const links = {
  "my-announcement": "/admin/communications/announcement",
  general: "/admin/communications/general",
  classroom: "/admin/communications/classroom",
  events: "/admin/communications/events",
};
