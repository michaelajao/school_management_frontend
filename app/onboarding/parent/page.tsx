...
export default function ParentOnboardingPage() {
  ...
  const submitOnboarding = async () => {
    ...
    try {
      ...
      localStorage.setItem("parentOnboardingData", JSON.stringify(formData));
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold">Parent/Guardian Setup</h1>
        <p className="text-muted-foreground mt-2">
          Complete your profile to connect with your child's education
        </p>
      ...
      <Card className="p-6">
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            <h2 className="font-semibold text-xl">Student Information</h2>
            <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-4 pt-4">
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Note: You'll be able to add more children to your account later.
              </p>
            </div>
          </div>
        )}
